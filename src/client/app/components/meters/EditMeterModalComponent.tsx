...
export default function EditMeterModalComponent(props: EditMeterModalComponentProps) {
	...
	// timezone
	const [timezone, setTimezone] = useState(props.meter.timezone? `${props.meter.timezone}` : '');
	...
	const handleSaveChanges = () => {
		...
		const meterHasChanges =
			(
				...
				props.meter.url != url ||
				props.meter.timezone? `${timezone}` : '' != timezone ||
				props.meter.gps? `${gps}` : '' != gps ||
								...
								<div style={tableStyle}>
									...
									<div style={formInputStyle}>
										...
										<div style={formInputStyle}>
											...
											<TimeZoneSelect
												current={props.meter.timezone}
												handleClick={e => handleTimezoneChange(e)} />
										</div>
										{/* GPS input*/}
										<div style={formInputStyle}>
